  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '13px 16px', borderBottom: '1px solid var(--line)' }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--ink0)' }}>
        ...
        <button onClick={onDismiss} style={{ background: 'none', border: 'none', color: 'var(--ink3)', fontSize: 16, cursor: 'pointer', padding: '0 2px' }}>✕</button>
      </div>
      ...
      <div style={{ padding: '14px 16px 16px' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button onClick={onStart} style={{
            ...
            color: 'var(--ink0)', cursor: 'pointer', fontFamily: 'inherit',
          }}>시작</button>
